...
@section('content')
    ...
    <div class="page-wrapper">
        <div class="container-xl py-4">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.kampanye.update', $kampanye->id) }}" method="POST"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama_kampanye"
                                value="{{ old('nama_kampanye', $kampanye->nama_kampanye) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="deskripsi" rows="4" class="form-control">{{ old('deskripsi', $kampanye->deskripsi) }}</textarea>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="status_kampanye" class="form-select">
                                @foreach (['aktif', 'nonaktif', 'selesai'] as $status)
                                    <option value="{{ $status }}"
                                        {{ old('status_kampanye', $kampanye->status_kampanye) === $status ? 'selected' : '' }}>
                                        {{ ucfirst($status) }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <input type="date" name="tanggal_mulai"
                                    value="{{ old('tanggal_mulai', $kampanye->tanggal_mulai) }}"
                            ...
                            <div class="col">
                                ...
                                <input type="date" name="tanggal_selesai"
                                    value="{{ old('tanggal_selesai', $kampanye->tanggal_selesai) }}"
                        ...
                        <div class="mb-3">
                            ...
                            @if ($kampanye->gambar_kampanye)
                                <div class="mb-2">
                                    <img src="{{ asset('storage/' . $kampanye->gambar_kampanye) }}" class="rounded"
