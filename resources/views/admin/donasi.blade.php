            ...
            <div class="col-12">
                <div class="d-flex align-items-center justify-content-between mb-4">
                    ...
                    <div class="d-flex gap-2 align-items-center">
                        ...
                        <a href="{{ route('admin.donasi.export-pdf') }}" class="btn btn-danger btn-sm fw-semibold shadow-sm" target="_blank">
                ...
                @if(session('success'))
                    <div class="alert alert-important alert-success alert-dismissible shadow-sm mb-4" role="alert">
                        <div class="d-flex">
                            <div><svg xmlns="http://www.w3.org/2000/svg" class="icon alert-icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M5 12l5 5l10 -10"/></svg></div>
                ...
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-body p-0 py-2"> {{-- Set p-0 tapi tambah py-2 --}}
                        <div class="table-responsive">
                            <table class="table table-vcenter w-100" id="tabel-donasi">
                                <thead>
                                    <tr>
                                        <th class="w-1">#</th>
                                        <th>Nama Donatur</th>
                                ...
                                <tbody id="tbody-donasi">
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="badge bg-green-lt text-green">🌱 {{ $data->jumlah_pohon ?? (int) floor($data->jumlah_donasi / 10000) }} pohon</span></td>
                                        <td>
...
<style>
    ...
    #tabel-donasi tbody td { padding: 16px 10px; border-bottom: 1px solid #f8f9fa; }
    ...
    .form-select-sm { border-radius: 8px !important; border: 1px solid #e6e7e9 !important; }
...
<script>
    ...
    $(document).ready(function() {
        table = $('#tabel-donasi').DataTable({
            "pageLength": 10,
            "dom": '<"d-flex justify-content-between align-items-center px-4 py-3"lf>rt<"d-flex justify-content-between align-items-center px-4 py-3"ip>',
            "language": {
