                    ...
                    <div class="row align-items-center g-4">
                        <div class="col-lg-6">
                            ...
                            <p class="fs-2 text-muted mb-5">
                                ...
                                pohon tertanam di lokasi yang tepat dan dipantau pertumbuhannya.
                            </p>
                            <div class="btn-list">
                            ...
                            <div class="card shadow-sm border-0 rounded-4">
                                <div class="card-body p-4 p-md-5">
                                    <div class="row align-items-center g-4">
                                        ...
                                        <div class="col-md-5">
                                            {{-- Placeholder untuk gambar Monitoring atau Ilustrasi --}}
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card card-stacked shadow-sm">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="text-muted">Reboisasi lahan kritis di pinggiran kota untuk paru-paru dunia.
                                    </p>
                                    <div class="mt-3">
                                ...
                                <div class="card-footer bg-transparent border-0">
                                    <a href="{{ route('views.donatur.donasi') }}"
                                        class="btn btn-success w-100 fw-bold">Donasi Sekarang</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            <div class="card p-4 border-0 shadow-sm h-100">
                                ...
                                <p class="text-muted small">Kami memastikan setiap pohon yang kamu tanam dipantau secara
                                    berkala melalui sistem monitoring kami.</p>
                        ...
                        <div class="col-md-6">
                            <div class="card p-4 border-0 shadow-sm h-100">
                                ...
                                <p class="text-muted small">Cek seberapa besar kontribusi oksigen yang telah dihasilkan
                                    dari
                                    hasil donasimu.</p>
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            <div class="img-responsive img-responsive-1by1 rounded-3 shadow-sm"
                                style="background-image: url({{ asset('assets/img/doc1.jpg') }})"></div>
                        </div>
                        <div class="col-md-4">
                            <div class="img-responsive img-responsive-1by1 rounded-3 shadow-sm"
                                style="background-image: url({{ asset('assets/img/doc2.jpg') }})"></div>
                        </div>
                        <div class="col-md-4">
                            <div class="img-responsive img-responsive-1by1 rounded-3 shadow-sm"
                                style="background-image: url({{ asset('assets/img/doc3.jpg') }})"></div>
                        </div>
                    </div>
                </div>
            </section>
